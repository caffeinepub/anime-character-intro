...
const AUTO_ADVANCE = 5e3;
function Particles({ color }) {
  const particles = Array.from({ length: 18 }, (_, i) => i);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: particles.map((i) => {
...
function SpeedLines({ color }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: lines.map((i) => {
    const top = i / 20 * 100;
...
function MouthOverlay({ color, active }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "0", cy: "4", rx: "18", ry: "10", fill: "#fff", opacity: "0.92" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "0", cy: "10", rx: "9", ry: "5", fill: "#e87a8a", opacity: "0.8" }),
...
function useTypewriter(text, duration, active) {
...
function App() {
  ...
  const [speedLines, setSpeedLines] = reactExports.useState(false);
  const [typing, setTyping] = reactExports.useState(true);
  const [particleKey, setParticleKey] = reactExports.useState(0);
  ...
  const replay = reactExports.useCallback(() => goTo(0), [goTo]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      ` }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: sweeping && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              ...
              animation: "sweep-across 0.55s cubic-bezier(0.4,0,0.2,1) forwards",
              zIndex: 50,
              pointerEvents: "none"
            }
          },
        ...
        speedLines && /* @__PURE__ */ jsxRuntimeExports.jsx(SpeedLines, { color: char.color }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Particles, { color: char.color }, particleKey),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    alignItems: "flex-end",
                    justifyContent: "center",
                    animation: fromLeft ? "enter-left 0.65s cubic-bezier(0.22,1,0.36,1) forwards" : "enter-right 0.65s cubic-bezier(0.22,1,0.36,1) forwards"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MouthOverlay, { color: char.color, active: !done })
                  ]
                },
                `img-${current}`
              )
          ...
          "div",
          {
            ...
            children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                              ...
                              animation: done ? "none" : "blink-cursor 0.6s steps(1) infinite",
                              opacity: done ? 0 : 1
                            }
                          }
                        )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: characters.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginLeft: "auto", textAlign: "right" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
                          fontSize: 11,
